...
clc 
%% Macros
global ne rho1 rho2 L1 L2 A1 A2 E1 E2 Iz1 Iz2  gamma_c ...
    H_fu  eta theory Kap1 Kap2 G1 G2 kL
theory = 'T';
...
[kL_sem_PB,kL_sem_SB] = function_SEM_Beam(wv);
figure
