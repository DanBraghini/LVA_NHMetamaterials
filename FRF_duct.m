...
% L1, L2: lengths of the segments of the structure L1-L2;
% A1, A2: cross sectional areas of thestructure A1-A2;
% kL: value of wavenumber times length. kL \in  [-pb*pi, pb*pi] \subset \R;
% pb = # of Brillouin Zones;
% c: sound velocity within the dute (temperature);
...
% This loop runs through the frequency vector
 for n=1:N 
    ...
    if boundary==0
           Dgn=[D1(1,1)  D1(1,2)                     0
                    D1(2,1)  D1(2,2)+D2(1,1) D2(1,2)
                        0           D2(2,1)              D2(2,2)];
    elseif boundary==1
           Dgn=[D1(1,1)  D1(1,2)                     0                         0 
                    D1(2,1)  D1(2,2)+D2(1,1) D2(1,2)                    0
                        0           D2(2,1)              D2(2,2)+D3(1,1)   D3(1,2)    
                        0               0                      D3(2,1)                 D3(2,2)];
    end        
...
%% plots
figure
plot(fv/1000,20*log10(abs(PV_SEM(:,2))),'r','MarkerSize',8,'LineWidth',1)
hold on
plot(fv/1000,20*log10(abs(PA_SEM(:,2))),'k','MarkerSize',8,'LineWidth',1)
if boundary==0
    plot(fv/1000,20*log10(abs(FRF_speakerO)),'g')
elseif boundary==1
    plot(x/1000,80+20*log10(abs(FRF_2)),'g')
end
